...
require(folderOfThisFile..'connection')
require(folderOfThisFile..'vec3')


CmdPositioner = {

    new = function(self, conn, pkg)
        local obj = { conn = conn, pkg = pkg or "entity"}
...
--The main class to interact with a running instance of Minecraft Pi.
    ...
    getBlocks = function(self, ...)
        ...
        return toInteger(self.conn:sendAndReceive("world.getBlocks", intFloor(arg)))
    end,
